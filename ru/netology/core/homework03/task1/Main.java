...
public class Main {
    ...
    private static final String PATH = "D:/java/Java Core/Homework 1/3.1/src/ru/netology/core/homework03/Games";
    ...
    private static void writeToTheLog(File file, boolean result) {
        LOG.append(file.isDirectory() ? "Каталог '" : "Файл '")
                ...
                .append((!result && file.exists()) ? ", уже существует!" : "")
                .append((!result && !file.exists()) ? ", неверно указан путь!" : "")
                .append("\n");
    }
